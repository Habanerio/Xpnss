...
public class CreditCardAccountTests : BaseAccountTests
{
    ...
    public CreditCardAccountTests()
    {
        ...
        _testClass = CreditCardAccount.New(userId, accountName, description, displayColor, creditLimit, interestRate);
    }
    ...
    public void CanCall_Load()
    {
        ...
        // Act
        var result = CreditCardAccount.Load(id, userId, accountName, balance, description, displayColor, creditLimit, interestRate, dateCreated, dateClosed, dateDeleted, dateUpdated);
    ...
    public void CanCall_New()
    {
        ...
        // Act
        var result = CreditCardAccount.New(userId, accountName, description, displayColor, creditLimit, interestRate);
    ...
    /// <summary>
    /// Tests that for Credit Card Accounts, a new DEPOSIT transaction will decrease the Balance owed.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Tests that for Credit Card Accounts, a new PURCHASE transaction will increase the Balance.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Tests that for Credit Card Accounts, a previous DEPOSIT transaction will INCREASE the Balance.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Tests that for Credit Card Accounts, a previous PURCHASE transaction will DECREASE the Balance.
    /// </summary>
    [Fact]
