...
/* Commenting out for now as they are abstract classes. Tests for actual account classes should cover these.
{
    ...
    public void CanCall_Deposit()
    {
        ...
        var amount = _fixture.Create<Money>();

        // Act
        _testClass.Deposit(dateOfDeposit, amount);
    ...
    public void CanCall_Withdraw()
    {
        ...
        // Act
        _testClass.Withdraw(dateOfWithdraw, amount);
    ...
    {
        Assert.Throws<ArgumentNullException>(() => _testClass.AdjustBalance(_fixture.Create<Money>(), _fixture.Create<DateTime>(), value));
    }
    ...
    {
        // Arrange
        var changeHistories = _fixture.Create<List<ChangeHistory>>();
    ...
    {
        Assert.Throws<ArgumentNullException>(() => _testClass.LoadChangeHistories(default(List<ChangeHistory>)));
    }
    ...
    {
        // Arrange
        var monthlyTotals = _fixture.Create<List<MonthlyAccountTotals>>();
    ...
    {
        Assert.Throws<ArgumentNullException>(() => _testClass.LoadMonthlyTotals(default(List<MonthlyAccountTotals>)));
    }
    ...
    {
        // Assert
        Assert.IsType<IReadOnlyCollection<ChangeHistory>>(_testClass.ChangeHistory);
    ...
    {
        // Assert
        Assert.IsType<IReadOnlyCollection<MonthlyAccountTotals>>(_testClass.MonthlyTotals);
...
{
    private class TestCreditAccount : CreditAccount
    {
    ...
    {
        Assert.Throws<ArgumentNullException>(() => _testClass.AdjustCreditLimit(_fixture.Create<Money>(), _fixture.Create<DateTime>(), value));
    }
    ...
    {
        Assert.Throws<ArgumentNullException>(() => _testClass.AdjustInterestRate(_fixture.Create<PercentageRate>(), _fixture.Create<DateTime>(), value));
    }
