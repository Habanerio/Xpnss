...
//    private readonly UpdateBalanceCommandTests.Handler _handler;

//    public UpdateBalanceCommandTests()
//    {
//        _repository = new Mock<IAccountsRepository>();

//        _handler = new AddTransactionAmount.Handler(_repository.Object);
//    }
...
//            new AddTransactionAmount.Handler(repository));
...
//    {
//        var command = new AddTransactionAmount.Command(
//            value,
