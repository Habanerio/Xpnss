...
//public class UpdateInterestRateCommandTests
//{
//    private readonly Mock<IAccountsRepository> _repository;

//    private readonly UpdateInterestRate.Handler _handler;

//    public UpdateInterestRateCommandTests()
//    {
//        _repository = new Mock<IAccountsRepository>();

//        _handler = new UpdateInterestRate.Handler(_repository.Object);
//    }
...
//    {
//        var command = new UpdateInterestRate.Command(
//            value,
