...
/// Not completed
/// </summary>
public class AddCreditLimitAdjustmentEndpoint : BaseEndpoint
{
        ...
        public void AddRoutes(IEndpointRouteBuilder app)
        {
            app.MapPatch("/api/v1/users/{userId}/accounts/{accountId}/credit-limit",
                    async (
                        ...
                        [FromBody] AddCreditLimitAdjustmentCommand command,
    ...
    public static async Task<IResult> HandleAsync(
        string userId,
        string accountId,
        AddCreditLimitAdjustmentCommand command,
    ...
    public sealed class Validator : AbstractValidator<AddCreditLimitAdjustmentCommand>
    {
        public Validator()
        {
            RuleFor(x => x).NotNull();
