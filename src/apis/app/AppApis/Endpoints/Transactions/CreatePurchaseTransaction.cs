...
public sealed class CreatePurchaseTransaction : BaseEndpoint
{
    public sealed class Endpoint : ICarterModule
    {
        public void AddRoutes(IEndpointRouteBuilder app)
        {
            app.MapPost("/api/v1/users/{userId}/transactions/purchase",
                    async (
                ...
                .WithDisplayName("New Purchase Transaction")
                .WithName("CreatePurchaseTransaction")
        ...
        CancellationToken cancellationToken)
    {
        ...
        var command = new CreatePurchaseTransactionCommand(userId, request);
        ...
        try
        {
            ...
            var response = ApiResponse<PurchaseTransactionDto>.Ok(transactionDto);
    ...
    public sealed class Validator : AbstractValidator<CreatePurchaseTransactionRequest>
    {
        public Validator()
        {
            RuleFor(x => x).NotNull();
            ...
            RuleFor(x => x.Items.TrueForAll(i => i.Amount >= 0)).Equal(true);
