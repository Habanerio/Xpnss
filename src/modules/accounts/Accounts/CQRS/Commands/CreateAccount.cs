...
public class CreateAccount
{
    public record Command(
        ...
        string DisplayColor = "") : IAccountsCommand<Result<ObjectId>>, IRequest;

    public class Handler(IAccountsRepository repository) : IRequestHandler<Command, Result<ObjectId>>
    {
        private readonly IAccountsRepository _repository = repository ??
                                                           throw new ArgumentNullException(nameof(repository));

        public async Task<Result<ObjectId>> Handle(Command request, CancellationToken cancellationToken)
        {
